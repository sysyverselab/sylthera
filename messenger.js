  ...
  (function () {
    ...
    window.FAM = {
      ...
      select: {
        ...
        // Un post
        post: ".post_row, .comment",
        // Avatar du post
        post_avatar: ".pro-ava img, .comment-avatar img",
        // Pseudo de l'auteur du post
        post_name: ".pro-name, .comment-author",
        // Date du post
        post_date: ".post_date time, .comment-time",
        // Contenu du post
        post_message: ".content-post, .comment .content.clearfix",
      ...
      lang: {
        loading: "Chargement",
        idle: "Votre messagerie est en veille.<br> Cliquez pour reprendre.",
        message_notif_singular: "$N nouveau message",
        message_notif_plural: "$N nouveau messages",
        new_messages: "Nouveaux Messages",

        new_topic: "Nouvelle conversation",
        start_topic: "Commencer une conversation",
        forum_name: "Conversation",
        topic_name: "SMS",

        msg_placeholder: "Envoyer un sms",
        title_placeholder: "Titre de la conversation",
        load_older: "Voir les anciens sms",
        delete_message: "Voulez-vous supprimer ce sms ?",

        topic_no_subject: "Vous devez indiquer un titre pour votre conversation.",
        topic_no_message: "Vous devez écrire un sms avant de démarrer votre conversation.",
        ...
        tooltip_send: "Envoyer un sms",
        tooltip_msg_quote: "Citer",
        tooltip_msg_edit: "Editer",
        tooltip_msg_delete: "Supprimer",

        error_sending: "Une erreur empêche l'envoi de votre sms. Réessayer ?",
